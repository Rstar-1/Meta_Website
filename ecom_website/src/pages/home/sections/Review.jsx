...
const Review = () => {
  ...
  return (
    <div className="w-full py-40">
      <div className="flex md-grid-cols-1 sm-grid-cols-1 items-center gap-12">

        <div className='w-20 md-w-full sm-w-full px-10 sm-px-1'>
        ...
        <div className="grid-cols-3 md-grid-cols-3 sm-grid-cols-1 gap-12 w-60 md-w-full sm-w-full px-10 sm-px-1">
      ...
      <div className="grid-cols-4 md-grid-cols-3 sm-grid-cols-1 gap-12">
