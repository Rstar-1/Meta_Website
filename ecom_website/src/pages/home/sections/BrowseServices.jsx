  ...
  const services = [
    {
      ...
      desc: "Crafting iconic brand identities, visual design systems, logos, and typography that make your brand stand out and inspire customer loyalty."
    },
    {
      id: 2,
      ...
      desc: "Engineering high-speed, mobile-responsive custom web platforms and e-commerce architectures optimized for maximum user engagement."
    },
    {
      id: 3,
      ...
      desc: "Executing high-yielding Meta & Google ad campaigns engineered to capture qualified leads, increase CTR, and maximize return on ad spend."
    },
    {
      id: 4,
      ...
      desc: "Building authentic community engagement, managing content calendars, and running high-converting vertical video creative on social channels."
    },
    {
      id: 5,
      ...
      desc: "Implementing multi-touch attribution, GA4 custom event dashboards, and data-driven Conversion Rate Optimization (CRO) audits."
    },
    {
      id: 6,
      ...
      desc: "Dominating search engine placements through technical SEO audits, high-intent keyword strategies, and authoritative content creation."
    }
  ];
